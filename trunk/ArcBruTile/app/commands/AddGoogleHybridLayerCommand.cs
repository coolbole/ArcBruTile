...
namespace BruTileArcGIS
{
    ...
    /// </summary>
    [Guid("CB53E7F9-2CBD-48EB-BE87-0F1B09E2390B")]
    [ClassInterface(ClassInterfaceType.None)]
    [ProgId("AddGoogleHybridCommand")]
    public sealed class AddGoogleHybridCommand : BaseCommand
    {
        ...
        /// </summary>
        public AddGoogleHybridCommand()
        {
            base.m_category = "BruTile";
            base.m_caption = "&Google";
            base.m_message = "Add Google Hybrid Layer";
        ...
        public override void OnClick()
        {
            try
            {
                ...
                map = mxdoc.FocusMap;
                BruTileLayer brutileLayer = new BruTileLayer(application, EnumBruTileLayer.GoogleHybrid);
                brutileLayer.Name = "Google Hybrid";
